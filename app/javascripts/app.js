...
import voting_artifacts from '../../build/contracts/VotingSystem.json'
...
window.castVote = function(candidate) {
  ...
  Voting.deployed().then(function(contractInstance) {
    contractInstance.castVote(candidateName, voteTokens, {gas: 140000, from: web3.eth.accounts[0]}).then(function() {
...
function populateTokenData() {
  Voting.deployed().then(function(contractInstance) {
    contractInstance.totalVotes().then(function(v) {
      $("#tokens-total").html(v.toString());
    });
    contractInstance.votesDistributed.call().then(function(v) {
      $("#tokens-sold").html(v.toString());
    });
    contractInstance.votesRemaining.call().then(function(v) {
      $("#tokens-remaining").html(v.toString());
    });
    contractInstance.votesPerETH().then(function(v) {
